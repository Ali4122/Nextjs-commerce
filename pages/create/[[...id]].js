...
const ProductsManager = () => {
    ...
    const handleUploadInput = e => {
        ...
        if(files.length === 0) 
        return dispatch({type: 'NOTIFY', payload: {error: 'Fayllar mavjud emas.'}})

        files.forEach(file => {
            if(file.size > 1024 * 1024)
            return err = 'Rasmning eng katta hajmi - 1 mb'

            if(file.type !== 'image/jpeg' && file.type !== 'image/png')
            return err = "Rasm formati noto'g'ri."
        ...
        return dispatch({type: 'NOTIFY', payload: {error: '5 tagacha rasmni tanlang.'}})
    ...
    const handleSubmit = async(e) => {
        ...
        return dispatch({type: 'NOTIFY', payload: {error: 'Autentifikatsiya haqiqiy emas.'}})

        if(!title || !price || !inStock || !description || !content || category === 'all' || images.length === 0)
        return dispatch({type: 'NOTIFY', payload: {error: "Iltimos, barcha maydonlarni to'ldiring"}})
            ...
            <form className="row" onSubmit={handleSubmit}>
                <div className="col-md-6">
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-6">
                            <label htmlFor="price">Omborda mavjud</label>
                    ...
                    <div className="input-group-prepend px-0 my-2">
                        ...
                        onChange={handleChangeInput} className="custom-select text-capitalize">
                            <option value="all">Hamma mahsulotlar</option>
                            {
                                categories.map(item => (
                ...
                <div className="col-md-6 my-4">
                    <div className="input-group mb-3">
                        <div className="input-group-prepend">
                            <span className="input-group-text">Yuklash</span>
                        </div>

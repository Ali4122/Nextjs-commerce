...
const Profile = () => {
    ...
    const changeAvatar = (e) => {
        ...
        if(!file)
            return dispatch({type: 'NOTIFY', payload: {error: 'Fayl mavjud emas.'}})

        if(file.size > 1024 * 1024) //1mb
            return dispatch({type: 'NOTIFY', payload: {error: 'Rasmning eng katta hajmi - 1 mb.'}})

        if(file.type !== "image/jpeg" && file.type !== "image/png") //1mb
            return dispatch({type: 'NOTIFY', payload: {error: "Rasm formati noto'g'ri."}})
        ...
        <div className="profile_page">
            ...
            <section className="row text-secondary my-3">
                <div className="col-md-4">
                    ...
                    <div className="form-group">
                        <label htmlFor="cf_password">Yangi parolni tasdiqlang</label>
                ...
                <div className="col-md-8">
                    <h3 className="text-uppercase">Buyurtmalar</h3>
                        ...
                        style={{minWidth: '600px', cursor: 'pointer'}}>
                            <thead className="bg-light font-weight-bold">
                                <tr>
                                    ...
                                    <td className="p-2">sana</td>
                                    <td className="p-2">jami</td>
                                    <td className="p-2">yetkazib berilgan</td>
                                    <td className="p-2">to'langan</td>
                                </tr>
                            </thead>

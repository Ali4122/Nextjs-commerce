        ...
        <div className="edit_user my-3">
            ...
            <div>
                <button className="btn btn-dark" onClick={() => router.back()}>
                    <i className="fas fa-long-arrow-alt-left" aria-hidden></i> Ortga qaytish
                </button>
            </div>

            <div className="col-md-4 mx-auto my-4">
                <h2 className="text-uppercase text-secondary">Foydalanuvchini tahrirlash</h2>

                <div className="form-group">
                    <label htmlFor="name" className="d-block">Ism</label>
                    <input type="text" id="name" defaultValue={editUser.name} disabled />
                </div>

                <div className="form-group">
                    <label htmlFor="email" className="d-block">Elektron manzil</label>
                ...
                <button className="btn btn-dark" onClick={handleSubmit}>Yangilash</button>
